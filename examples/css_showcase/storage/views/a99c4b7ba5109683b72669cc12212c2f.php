...
<?php $this->sections[trim('title', "'\"")] = 'CSS Framework Multi-Support Hub — Spartan'; ?>
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 1.5rem;">
    <div class="glass-card">
        ...
        <a href="/tailwind" style="color: var(--accent); font-weight: 600; text-decoration: none;">View Tailwind Demo →</a>
    </div>
    ...
    <div class="glass-card">
        ...
        <a href="/openprops" style="color: var(--accent); font-weight: 600; text-decoration: none;">View Open Props Demo →</a>
    </div>
