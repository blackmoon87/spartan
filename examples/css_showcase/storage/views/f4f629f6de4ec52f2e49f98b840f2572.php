...
<?php $this->sections[trim('title', "'\"")] = 'Vanilla Glassmorphism — Spartan'; ?>
...
<div class="glass-card">
    ...
    <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 1rem; margin-top: 1rem;">
        ...
        <div style="background: rgba(255,255,255,0.03); padding: 1rem; border-radius: 8px; text-align: center;">
            <div style="font-size: 1.5rem; font-weight: 700; color: var(--accent);"><?php echo htmlspecialchars(($val) ?? '', ENT_QUOTES, 'UTF-8'); ?></div>
            <div style="font-size: 0.8rem; color: var(--text-muted);"><?php echo htmlspecialchars(($label) ?? '', ENT_QUOTES, 'UTF-8'); ?></div>
        </div>
        <?php endforeach; ?>
    </div>
</div>
