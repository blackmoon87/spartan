...
<?php $this->sections[trim('title', "'\"")] = 'Awwwards / Godly Style Glassmorphic Showcase — Spartan'; ?>
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 1.5rem; margin-bottom: 1.5rem;">
    ...
    <div class="glass-card" style="transition: transform 0.2s, border-color 0.2s; cursor: pointer;">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1rem;">
            <h3 style="font-size: 1.1rem; font-weight: 700; color: #fff;"><?php echo htmlspecialchars(($item['title']) ?? '', ENT_QUOTES, 'UTF-8'); ?></h3>
