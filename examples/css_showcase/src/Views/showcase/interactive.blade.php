...
@section('title', 'Interactive Animations, Sliders & Motion Showcase — Spartan')
...
<div class="gallery-grid">
    ...
    <div class="gallery-card">
        <div class="card-bg" style="background: linear-gradient(135deg, {{ $item['color'] }}, #090d16);"></div>
        <div class="overlay">
            <span style="font-size: 0.7rem; color: var(--accent); font-weight: 700;">{{ $item['category'] }}</span>
            <h4 style="font-size: 0.95rem; font-weight: 700; color: #fff; margin-top: 0.2rem;">{{ $item['title'] }}</h4>
        </div>
    </div>
    @endforeach
</div>
